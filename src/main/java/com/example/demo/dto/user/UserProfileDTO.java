...
public class UserProfileDTO {
    ...
    public static UserProfileDTO fromUser(User user, Post[] posts, Integer followers, Integer following) {
...
//        userProfileDTO.setFollowedTags(user.getFollowedTags().size());
